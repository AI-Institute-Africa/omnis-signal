...
print("╔" + "="*78 + "╗")
print("║" + " "*15 + "ENHANCED SCRAPER HUB - 10 CATEGORIES DASHBOARD" + " "*15 + "║")
print("╚" + "="*78 + "╝\n")
...
try:
    ...
    category_descriptions = {
        'banking': 'Banks, accounts, loans, fees, digital features',
        'telecom': 'Providers, data bundles, voice rates, coverage metrics',
        'schools': 'Educational institutions, tuition, facilities, pass rates',
        'universities': 'Higher education institutions, programs, fees',
        'insurance': 'Providers, policies (motor, medical, life, property)',
        'utilities': 'Utility providers and services',
        'solar': 'Solar energy providers and installations',
        'mobility': 'Car dealerships, vehicles, driving schools, bus routes',
        'transport': 'Transportation services',
        'hotels': 'Accommodation providers and stays'
    }
    ...
    print(f"🏷️  SOURCES BY CATEGORY (10 Categories)")
    for cat in sorted(categories.keys()):
        desc = category_descriptions.get(cat, 'Unknown')
        print(f"   {cat.upper():<12} : {categories[cat]:2} sources - {desc}")
    ...
    for record in records[-10:]:
        ...
        price = f"£{record.get('price_value', 0) or 0:.2f}"[:10]
    ...
    print(f"\n💡 USEFUL COMMANDS")
    print(f"   python show_dashboard.py          # This dashboard")
    ...
    print(f"   python refine_categories.py       # Update categories")
    print(f"\n" + "="*80)
